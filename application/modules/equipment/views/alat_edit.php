                                ...
                                <form action="" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="kode" class="form-control " placeholder="Enter kode" value="<?= set_value('kode', $row->kode)?>">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <option value="">Select location</option>
                                                    <?php if($location) { 
                                                        ...
                                                        <option value="<?=$r['id']?>"<?=set_select('location_id', $r['id'],($row->location_id)?TRUE:FALSE)?>><?=$r['name']?></option>
                                                    <?php  } } ?>
                                                </select>
                                                <?=form_error('location_id', '<span class="help-block error">', '</span>')?>
                                            </div>
                                        </div>
