                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i>User Accounts [edit]
                                </div>
                            </div>
                                ...
                                <form action="" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control " placeholder="Email Address" value="<?= set_value('email', $row->email)?>"/>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="full_name" class="form-control " placeholder="Enter full name" value="<?= set_value('full_name', $row->full_name)?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="username" class="form-control " placeholder="Enter username" value="<?= set_value('username', $row->username)?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="initial" class="form-control " placeholder="Enter initial" value="<?= set_value('initial', $row->initial)?>">
                                                ...
                                                <div class="radio-list">
                                                    <?php foreach ($role as $i=>$v){?>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="role" <?=set_radio('role',$i,($row->role==$i)?TRUE:FALSE)?> value="<?=$i?>"/>
                                                            <?=$v?>
                                                        </label>
                                                    <?php }?>
                                                </div>
