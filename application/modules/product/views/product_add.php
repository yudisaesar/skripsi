                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i>Product [add]
                                </div>
                            </div>
                                ...
                                <form action="" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="nama_produk" class="form-control " placeholder="Enter name" value="<?= set_value('nama_produk')?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="no_batch" class="form-control " placeholder="Enter no_batch" value="<?= set_value('no_batch')?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="lot_no" class="form-control " placeholder="Enter lot_no" value="<?= set_value('lot_no')?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="cont_no" class="form-control " placeholder="Enter cont_no" value="<?= set_value('cont_no')?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="potency" class="form-control " placeholder="Enter potency" value="<?= set_value('potency')?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="date" name="exp_date" class="form-control " placeholder="Enter exp_date" value="<?= set_value('exp_date')?>">
