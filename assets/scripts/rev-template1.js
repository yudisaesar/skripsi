            ...
            if (idTable == 'price'){
                $.ajax({
                    ...
                    data: {
                        ...
                        "service": jqInputs[1].value,
                        "fixed": jqInputs[2].value,
                    },
                    success:function(data){
                        Metronic.stopPageLoading();
                        if(data == 'OK'){
                ...
                $.ajax({
                    ...
                    data: {
                        "id": dataId, 
                        "company_id": company_id,
                        "fee_1": jqInputs[0].value,
                        "fee_2": jqInputs[1].value,
                        "fee_3": jqInputs[2].value,
                        "fee_4": jqInputs[3].value,
                        "fee_5": jqInputs[4].value,
                        "fee_6": jqInputs[5].value,
                        "fee_7": jqInputs[6].value,
                        "fee_8": jqInputs[7].value,
                        "fee_9": jqInputs[8].value,
                        "fee_10": jqInputs[9].value,
                        "fee_11": jqInputs[10].value,
                        "fee_12": jqInputs[11].value,
                        "id_table" : idTable
                    },
                    success:function(data){
                        Metronic.stopPageLoading();
